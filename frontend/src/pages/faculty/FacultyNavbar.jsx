                ...
                <div className="container-fluid">
                    ...
                    <div className={`collapse navbar-collapse ${styles.navbarCollapse}`} id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li className="nav-item"><Link to="/faculty/dashboard" className={`nav-link ${styles.navLink}`}>Dashboard</Link></li>
                            <li className="nav-item"><Link to="/faculty/profile" className={`nav-link ${styles.navLink}`}>Profile</Link></li>
                            <li className="nav-item"><Link to="/faculty/uploadResult" className={`nav-link ${styles.navLink}`}>Upload Results</Link></li>
